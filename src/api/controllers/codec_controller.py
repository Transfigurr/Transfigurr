async def get_all_codecs():
    return {
        ...
        "vp8": {"containers": ["mp4", "matroska"], "encoders": ["libvpx"]},
...
async def get_all_encoders():
    return {
        ...
        "libvpx": {"presets": ["ultrafast", "superfast", "veryfast", "faster", "fast", "medium", "slow", "slower", "veryslow", "placebo"], "tune": ["none"], "profile": ["auto"], "level": ["auto"]},
